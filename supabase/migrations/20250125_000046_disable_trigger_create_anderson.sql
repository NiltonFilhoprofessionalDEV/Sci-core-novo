-- =====================================================
-- MIGRATION: Desabilitar trigger e criar Anderson manualmente
-- Data: 2025-01-25
-- Descrição: Desabilitar trigger handle_new_user temporariamente
--           e criar usuário Anderson manualmente
-- =====================================================

-- 1. Desabilitar trigger temporariamente
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- 2. Verificar se o usuário já existe e deletar se necessário
...
-- 3. Inserir usuário Anderson na tabela auth.users
...
-- 4. Criar perfil manualmente com seção e equipe
DO $$
DECLARE
...
BEGIN
    ...
    RAISE NOTICE 'Perfil criado com seção: % e equipe: %', sbcf_secao_id, alfa_equipe_id;
END $$;

-- 5. Recriar o trigger original

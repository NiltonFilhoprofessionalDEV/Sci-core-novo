...
export async function GET(req: NextRequest) {
  try {
    ...
    if (dataInicio) query = query.gte('data_tempo_resposta', dataInicio)
    if (dataFim) query = query.lte('data_tempo_resposta', dataFim)
    ...
    console.error('Erro ao buscar Tempo Resposta:', error)
    return NextResponse.json(

...
export async function GET(req: NextRequest) {
  try {
    ...
    if (dataInicio) query = query.gte('data_ocorrencia', dataInicio)
    if (dataFim) query = query.lte('data_ocorrencia', dataFim)
    ...
    console.error('Erro ao buscar Ocorrências Não Aeronáuticas:', error)
    return NextResponse.json(

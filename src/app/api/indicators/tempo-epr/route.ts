...
export async function GET(req: NextRequest) {
  try {
    ...
    if (dataInicio) query = query.gte('data_exercicio_epr', dataInicio)
    if (dataFim) query = query.lte('data_exercicio_epr', dataFim)
    ...
    console.error('Erro ao buscar Tempo EPR:', error)
    return NextResponse.json(

...
// Agrupar dados por equipe e data para facilitar o processamento
const groupedData = {};
jsonData.forEach(item => {
  const key = `${item.equipe}_${item.data}`;
  if (!groupedData[key]) {
    groupedData[key] = [];
  }
...
console.log(`),`);
console.log(`funcionarios_goiania AS (`);
console.log(`  -- Obter funcionários de Goiânia com seus IDs`);
console.log(`  SELECT f.id as usuario_id, f.nome_completo, f.equipe_id, e.nome as equipe_nome`);
console.log(`  FROM funcionarios f`);
console.log(`  JOIN equipes e ON f.equipe_id = e.id`);
console.log(`  WHERE f.secao_id = (SELECT secao_id FROM info_base)`);
console.log(`)`);
...
console.log(`)`);
console.log(`SELECT `);
console.log(`  fg.secao_id,`);
console.log(`  fg.equipe_id,`);
console.log(`  fg.usuario_id,`);
...
console.log(`  fg.equipe_nome as equipe,`);
console.log(`  NOW(),`);
console.log(`  NOW()`);
console.log(`FROM (`);
...
console.log(`JOIN funcionarios_goiania fg ON fg.nome_completo = fd.data_nome`);
